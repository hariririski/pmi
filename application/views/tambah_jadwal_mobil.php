...
<div class="container">
 <?php echo $this->session->flashdata('pesan')?>
    <form class="page-contact__form" action="<?php echo site_url();?>login/proses_tambah_jadwal_mobil" method="POST" >
        <h2 class="page-contact__form-heading">Tambah Jadwal Mobil</h2>
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="form-group">
                    <input type="date" class="form-control" name='tgl_post' placeholder="Tangal">
                </div>
            </div>
            <div class="col-lg-5">
                <div class="form-group">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="form-group">
                    <textarea rows="5" class="form-control" name='alamat' placeholder="Alamat Atau posisi"></textarea>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
