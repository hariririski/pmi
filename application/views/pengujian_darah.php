        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="description-list-block">
                    <h5 class="description-list-block-header">Pengujian Darah</h5>
                    <p class="description-list-block-text">

                        1. Pengujian yang dilakukan oleh UTD PMI telah memakai Elisa seperti standarisasi yang telah di tetapka oleh WHO<br>
						2. Pengujian ini bertujian agar darah yang diberikan kepada pasien aman untuk digunakan<br>
						3. Setiap donasi darah akan di cek tipe darah tes penyakit (Hepatitis B, Hepatitis C, HIV dan Sifilis)<br>
						4. Jika hasil tes positif, maka inormasi akan diberikan kepda pendonor. Hasil ini bersifat rahasia dan hanya di informasikan kepada pendonor<br>
