        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="description-list-block">
                    <h5 class="description-list-block-header">Pengolahan</h5>
                    <p class="description-list-block-text">

                        1. Donasi darahakan di data dalam database<br>
						2. Darah donasi akan di pisahkan berdasarkan komponennya yaitu PRC(sel darah merah), TC(Trombosit concentrat/trombosit) dan PC(plasma concentrat/plasma darah)<br>
						3. Hasil pengolahan akan diuji<br>
