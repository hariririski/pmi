        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="description-list-block">
                    <h5 class="description-list-block-header">Penyimpanan Darah</h5>
                    <p class="description-list-block-text">

                        1. Setalah hasil uji saring darah dinyatakan non reaktif maka darah akan disimpanan pada lemari pendingin (blood freezer) yang bertanda darah sehat<br>
						2. PRC (sel darah merah) akan disimpan pada suhu 2-6 derajat celcius<br>
						3. TC(trombosit) akan disimpan pada suhu 22-24 derajat celcius<br>
						4. Plasma dan cryoprecipate dibekukan dan disimpan dalam lemari pendingin sampai satu tahun<br>
